...
All eight pattern types, generated by the model from the same Gray-Scott equations with different (f, k) values:

![Gray-Scott Reaction-Diffusion Pattern Catalog — mitosis, coral, spirals, spots, stripes, worms, holes, chaos](images/pattern_catalog.png)
...
The interestingness map across (f, k) parameter space — the cyan line is the pattern boundary, the black void is dead space, the bright region is the complexity ridge:

![Gray-Scott Interestingness Map — complexity peaks at the boundary of the patterned region](images/interestingness_map.png)
...
The four criticality tests — order parameter, susceptibility, distribution, and spatial correlation functions showing power-law vs exponential decay:

![Criticality Analysis — power-law spatial correlations at the boundary, susceptibility peak, continuous transition](images/criticality_tests.png)
...
The patterns turned into sound — waveforms and spectrograms for stripes, spots, mitosis, coral, and ecosystem dynamics:

![Sonification of Dynamical Systems — waveforms and spectrograms of reaction-diffusion patterns converted to audio](images/spectrograms.png)
