...
The ecosystem dynamics from a surviving run (seed 2, 500 steps), generated by the model:

![Emergent population dynamics — Lotka-Volterra oscillations across three trophic levels](images/ecosystem_dynamics.png)
